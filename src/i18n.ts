...
const STRINGS: Record<Locale, Dict> = {
  es: {
    ...
    'pens.golazo': '¡AL RINCÓN!', 'pens.unstoppable': 'Inatajable. Gol rival.',
    'home.daily': 'Torneo del día', 'home.dailyHint': 'La misma semilla para todos, hoy.',
    'daily.board': 'Campeones de hoy',
    'daily.boardEmpty': 'Nadie ganó todavía. Sé el primero.',
    'daily.boardError': 'No se pudo cargar la tabla.',
    'daily.loading': 'Cargando…',
    'daily.played': 'Ya jugaste el torneo de hoy',
    'daily.back': 'Mañana hay semilla nueva.',
    'daily.free': 'Jugar torneo libre',
    'daily.champ': '¡Campeón del día!',
    'daily.enterName': 'Campeón del día: dejá tu nombre en la tabla',
    'daily.namePh': 'Tu nombre',
    'daily.submit': 'Inscribirme',
    'daily.submitted': 'Quedaste en la tabla de hoy 🏆',
    'daily.error': 'No se pudo conectar. Probá de nuevo.',
